...
books_titles = selector.css(".product_pod h3 a::attr(title)").getall()
...
books_prices = selector.css(".product_price .price_color::text").getall()
...
for product in selector.css(".product_pod"):
    ...
    print(f"titulo: {title},", f"preco: {price}")
